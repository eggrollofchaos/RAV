...
- Runner lineage: `gcp-spot-runner v0.6.13-reconciler-deploy-helper` (IXQT/RAV wrapper ops/build/monitor and RAV submit now route through shared profiled dispatch helper to reduce adapter duplication).
...
- Runner lineage docs synchronized to `gcp-spot-runner v0.6.13-reconciler-deploy-helper` in:
  - `README.md`
  - `gcp/GCP_NOTES.md`
