...
- Runner lineage: `gcp-spot-runner v0.6.6-restart-state-convergence` (reconciler restart success now persists instance metadata and converges `RESTARTING -> RUNNING` state).
...
- Runner lineage docs synchronized to `gcp-spot-runner v0.6.6-restart-state-convergence` in:
  - `README.md`
  - `gcp/GCP_NOTES.md`
