...
Updated:
- App version to `v0.2.39-wrapper-dispatch-runtime-contract`.
- Runner lineage docs synchronized to `gcp-spot-runner v0.6.31-wrapper-dispatch-runtime-contract` in:
  - `README.md`
  - `gcp/GCP_NOTES.md`
Added:
