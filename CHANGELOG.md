...
- Runner lineage: `gcp-spot-runner v0.6.12-safe-wrapper-fallback` (IXQT/RAV wrapper ops/build/monitor and RAV submit now route through shared profiled dispatch helper to reduce adapter duplication).
...
- Runner lineage docs synchronized to `gcp-spot-runner v0.6.12-safe-wrapper-fallback` in:
  - `README.md`
  - `gcp/GCP_NOTES.md`
