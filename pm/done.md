...
- 2026-06-04: Recorded RAV data strategy decisions. Source: [RAV data management decisions](../docs/knowledge-base/decisions/data-management.md).
- 2026-06-25: Captured current initiative progress and remaining work. Source: [RAV initiatives](../docs/INITIATIVES.md).
- 2026-06-25: Imported sanitized reference lanes from the older chest X-ray prototype without notebooks, PDFs, screenshots, checkpoints, or class/personal prose. Source: [Chest X-Ray EVA-VLM Reference Pipelines](../reference_pipelines/chest_xray_eva_vlm/README.md).
