...
Current version map:
- `RAV` app version: `v0.2.34-reconciler-deploy-wrapper-helper` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.26-reconciler-deploy-wrapper-helper` (`version.py`)
