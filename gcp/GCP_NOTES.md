...
Current version map:
- `RAV` app version: `v0.2.37-state-helper-runtime-loader` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.29-state-helper-runtime-loader` (`version.py`)
