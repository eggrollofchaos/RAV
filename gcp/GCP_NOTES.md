...
Current version map:
- `RAV` app version: `v0.2.24-submit-shell-preamble-helper` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.16-submit-shell-preamble-helper` (`version.py`)
