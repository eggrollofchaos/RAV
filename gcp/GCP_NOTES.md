...
Current version map:
- `RAV` app version: `v0.2.31-wrapper-runtime-init-helper` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.23-wrapper-runtime-init-helper` (`version.py`)
