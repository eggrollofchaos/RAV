...
Current version map:
- `RAV` app version: `v0.2.35-wrapper-command-surface-helpers` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.27-wrapper-command-surface-helpers` (`version.py`)
