...
Current version map:
- `RAV` app version: `v0.2.11-reconciler-profile-wrapper` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.5.2-reconciler-profile-runtime` (`version.py`)
