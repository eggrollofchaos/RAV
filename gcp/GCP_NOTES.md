...
Current version map:
- `RAV` app version: `v0.2.42-runner-bootstrap-discovery` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.34-runner-bootstrap-discovery` (`version.py`)
