...
- Repo: `RAV`
- Runner: external checkout at `../gcp-spot-runner` (or sibling worktree `../gcp-spot-runner-codex`)
...
Current version map:
- `RAV` app version: `v0.2.45-profile-install-runtime-contracts` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.37-profile-install-runtime-contracts` (`version.py`)
