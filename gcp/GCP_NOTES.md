...
Current version map:
- `RAV` app version: `v0.2.43-project-wrapper-runtime-helpers` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.35-project-wrapper-runtime-helpers` (`version.py`)
