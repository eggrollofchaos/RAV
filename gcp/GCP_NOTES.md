...
Current version map:
- `RAV` app version: `v0.2.46-profile-install-runtime-contracts` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.38-profile-install-runtime-contracts` (`version.py`)
