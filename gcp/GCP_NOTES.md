...
Current version map:
- `RAV` app version: `v0.2.44-project-wrapper-command-helpers` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.36-project-wrapper-command-helpers` (`version.py`)
