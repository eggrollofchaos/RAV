...
Current version map:
- `RAV` app version: `v0.2.26-wrapper-direct-compat-dispatch` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.18-wrapper-direct-compat-dispatch` (`version.py`)
