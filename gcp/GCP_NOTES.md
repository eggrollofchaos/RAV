...
Current version map:
- `RAV` app version: `v0.2.25-state-helpers-wrapper-thin` (`src/rav_chest/version.py`)
- `gcp-spot-runner` runner version: `v0.6.17-state-helpers-wrapper-adapter` (`version.py`)
